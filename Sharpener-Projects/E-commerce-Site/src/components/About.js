...
const About = () => {
  return (
    <Container className="about-container d-flex align-items-center justify-content-center my-4">
      <Row className="align-items-center text-center text-md-left">
        <Col md={6} className="mb-4 mb-md-0 d-flex justify-content-center">
          <img
            src="https://images.pexels.com/photos/3776838/pexels-photo-3776838.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt="About Us"
